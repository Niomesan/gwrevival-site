<template>
  <div class="flex items-center flex-col justify-center w-screen pt-17 xl:pt-0 xl:h-screen text-white constantia">
    ...
    <div id="bgbase" class="w-[80%] xl:w-[46%] pt-8 p-3 border-gray-300 border-1 border-x-3 rounded-b-lg">
      <p
        ...
        celebrating and preserving the rich legacy of this timeless MMORPG. Whether you’re a veteran seeking nostalgia
        or a newcomer eager to experience the classic gameplay, you’ll find a vibrant, friendly group of like-minded
        players here. We host regular events, share tips and builds, and offer guidance for both PvE and PvP content.
        From revisiting iconic areas to tackling elite missions, our goal is to keep the spirit of Tyria alive. Join us,
      ...
      <div class="flex flex-col lg:flex-row gap-5 mb-3 w-[100%] p-2 lg:p-0 justify-center">
